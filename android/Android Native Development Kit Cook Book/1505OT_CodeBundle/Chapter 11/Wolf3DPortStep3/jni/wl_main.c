...
//
	...
	LOGI(3, "NoWat: %d", NoWait);
	if (!NoWait)
		PG13();
	
	LOGI(3, "check for demo");
...
int WolfMain(int argc, char *argv[])
{
	...
	LOGI(2, "game data dir %s", datadir);
	//get the dimension
	...
	LOGI(2, "vheight=%d; vwidth=%d", vheight, vwidth);
/*	glob_t globbuf;
	...
	if (w1 == false && s1 == false && s2 == false && s3 == false && s0 == false && w0 == false){Quit("NO WOLFENSTEIN 3-D DATA FILES TO BE FOUND!");}

	if (MS_CheckParm("wolf")) {
		printf("You Chose Full Wolf3D");
		w0 = false;
		s0 = false;
		s1 = false;
		s2 = false;
	...
	if (MS_CheckParm("wolfsw")) {
		printf("You Chose Shareware Wolf3D");
		w1 = false;
		s0 = false;
		s1 = false;
		s2 = false;
	...
	if (MS_CheckParm("sodemo")) {
		printf("You Chose Shareware Spear of Destiny");
		w0 = false;
		w1 = false;
		s1 = false;
		s2 = false;
	...
	if (MS_CheckParm("sod")) {
		printf("You Chose Full Spear of Destiny");
		w0 = false;
		s0 = false;
		w1 = false;
		s2 = false;
	...
	if (MS_CheckParm("sodm2")) {
		printf("You Chose Full Spear of Destiny Mission 2");
		w0 = false;
		s0 = false;
		s1 = false;
		w1 = false;
	...
	if (MS_CheckParm("sodm3")) {
		printf("You Chose Full Spear of Destiny Mission 3");
		w0 = false;
		s0 = false;
		s1 = false;
		s2 = false;
